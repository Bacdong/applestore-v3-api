...
| Tên cột                  | Kiểu dữ liệu    | Thuộc tính       | Giá trị mặc định | Mô tả                                |
| ------------------------ | --------------- | ---------------- | ---------------- | ------------------------------------ |
| brief                    | varchar(64)     |                  |                  | Mô tả vai trò                        |
...
| updated                  | DateTime        |                  | DateTime.UtcNow  | Ngày chỉnh sửa/cập nhật giỏ hàng     |
...
| created                  | DateTime        |                  | DateTime.UtcNow  | Ngày tạo contact                     |
...
| created                  | DateTime        |                  | DateTime.UtcNow  | Ngày tạo đơn hàng                    |
| updated                  | DateTime        |                  | DateTime.UtcNow  | Ngày chỉnh sửa/cập nhật đơn hàng     |
...
| inventory                | integer         | not null         | 0                | Số lượng tồn kho                     |
| viewCount                | integer         | not null         | 0                | Số lượt xem của sản phẩm             |
| created                  | datetime        |                  | DateTime.UtcNow  | Thời gian tạo sản phẩm               |
| updated                  | datetime        |                  | DateTime.UtcNow  | Thời gian chỉnh sửa/cập nhật sản phẩm|
...
| isDefault                | boolean         |                  |                  | Ảnh mặc định                         |
| created                  | integer         |                  | DateTime.UtcNow  | Ngày thêm hình ảnh                   |
| updated                  | datetime        |                  | DateTime.UtcNow  | Ngày chỉnh sửa/cập nhật hình ảnh     |
